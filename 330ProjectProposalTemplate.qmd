...
Equal Variance - The residuals vs fitted values plot seems to show homoskedasticity except for a slight curve and truncation at the end, and a few outliers here and there. All in all, the assumption of Equal Variance seems to be met
